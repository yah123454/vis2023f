...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>從事與藝術相關的工作者填寫問卷的人數較多</li>
    <li>從事與藝術相關的工作者大多選擇減少包裝、再生材料、節約能約的方式來減少碳排放</li>
    <li>減少商務差旅在工作室、替代空間、藝術團體、美術館、藝術園區占比都能排到第4或第5名</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#B5CAA0","#F19483","#FFBA84","#FAD689","#A5DEE4","#7DB9DE"])
  .unknown("#BEBEBE")
)}
