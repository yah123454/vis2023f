...
function _6(Plot,plot1,data,fillColor){return(
Plot.plot({  
	...
	y: {grid: true, label: "count"},  
	marks: [    
		Plot.rectY(data, Plot.binX({ y: "count" }, { x: "Year", interval: 1, fill: fillColor, tip: plot1.tip_choose })),    
		Plot.gridY({ interval: 1, stroke: "white", strokeOpacity: 0.5 })
	 ]
})
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Plot","plot1","data","fillColor"], _6);
  return main;
}
